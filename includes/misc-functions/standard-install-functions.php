<?php
/**
 * Installaion Functions for the Church Plant Theme Bundle. This file is standard for any Theme Bundle and should be left alone other than find and replacing.
 ...
 */
require( CHURCH_PLANT_THEME_BUNDLE_PLUGIN_DIR . 'includes/misc-functions/class-parent-plugin-installation.php' );
require( CHURCH_PLANT_THEME_BUNDLE_PLUGIN_DIR . 'includes/misc-functions/custom-install-functions.php' );
 ...
 * @return void
 */
function church_plant_theme_bundle_install() {
	...
	$mp_core_options['mp_stacks_theme_bundle_being_installed'] = array( 
		'theme_bundle_slug' => 'church_plant_theme_bundle',
		'fancy_title' => 'Church Plant Theme Bundle',
		'support_url' => 'https://mintplugins.com/support/church-plant-theme-bundle-support/',
		'support_email' => 'support@mintplugins.com',
		'required_theme_dirname' => apply_filters( 'church_plant_theme_bundle_required_theme_dirname', 'knapstack' ),
	...
	update_option( str_replace("_", "-", $mp_core_options['mp_stacks_theme_bundle_being_installed']['theme_bundle_slug'] ) . '_license_status_valid', false );
...
register_activation_hook( CHURCH_PLANT_THEME_BUNDLE_PLUGIN_FILE, 'church_plant_theme_bundle_install' );
 ...
 * @return void
 */
function church_plant_theme_bundle_admin_init(){
		
	//Set up the auto redirects to install dependant plugins
	global $mp_core_options, $church_plant_theme_bundle_installation_routine;
...
add_action( 'init', 'church_plant_theme_bundle_admin_init' );
 ...
 */
function church_plant_theme_bundle_initialize_default_items_setup( $mp_core_options, $theme_bundle_slug ){
	
	if ( $theme_bundle_slug == 'church_plant_theme_bundle' ){
...
add_filter( 'mp_core_parent_plugin_installation_complete_filter', 'church_plant_theme_bundle_initialize_default_items_setup', 10, 2 );
 ...
 * @return   void
 */
function church_plant_theme_bundle_switch_theme_workaround(){		
	...
	$fancy_theme_name = apply_filters( 'church_plant_theme_bundle_fancy_theme_name', NULL );
...
add_action( 'wp_die_handler', 'church_plant_theme_bundle_switch_theme_workaround' );
 ...
 * @return void
 */
function church_plant_theme_bundle_kill_edd_welcome(){
...
add_action( 'plugins_loaded', 'church_plant_theme_bundle_kill_edd_welcome' );