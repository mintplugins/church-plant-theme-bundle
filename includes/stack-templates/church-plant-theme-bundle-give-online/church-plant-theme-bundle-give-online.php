<?php
		/**
	   	 * Add Give Online to the list of installed stack templates
	   	 *
	   	 * @since    1.0.0
	   	 * @link     http://mintplugins.com/doc/mp_stacks_templates_add_church_plant_theme_bundle_give_online
	   	 * @see      function_name()
	   	 * @param    array $installed_templates See link for description.
	   	 * @return   array $installed_templates See link for description.
	   	 */
	   	function mp_stacks_templates_add_church_plant_theme_bundle_give_online( $installed_templates ){

	   		$installed_templates['mp_stacks_church_plant_theme_bundle_give_online_array'] = array(
	   			'template_slug' => 'church_plant_theme_bundle_give_online',
	   			'template_title' => __( 'Give Online', 'church_plant_theme_bundle' ),
	   			'template_description' => __('The "Give Online" stack template included in the Church Plant Theme Bundle', 'church_plant_theme_bundle' ),
	   			'template_tags' => 'church',
	   			'template_preview_img' => '',
	   			'template_demo_url' => 'https://demo.mintplugins.com/church-plant/stack/church-plant-theme-bundle-give-online',
	   		);

	   		return $installed_templates;

	   	}
	   	add_filter( 'mp_stacks_installed_templates', 'mp_stacks_templates_add_church_plant_theme_bundle_give_online' );

		/**
		 * This function holds and returns the Give Online Template Array
		 *
		 * @since    1.0.0
		 * @link     http://mintplugins.com/doc/mp-stacks-stack-template-function
		 * @return   array The Stack Template Aray
		 */
		function mp_stacks_church_plant_theme_bundle_give_online_array(){

			$template_array = array (
  'stack_title' => '',
  'stack_description' => 'Created using: Created using: Created using: Church Plant Theme Bundle\'s "Blog" Stack.',
  'stack_bricks' => 
  array (
    'brick_1' => 
    array (
...
',
          ...
          array (
            ...
            'brick_text' => 
            array (
              'value' => '&lt;p&gt;[churchtithewp mode=&quot;button&quot; link_text=&quot;Give Online&quot; open_style=&quot;in_modal&quot;]&lt;/p&gt;
',
              'attachment' => false,
            ),
          ),
      ...
      array (
        'value' => '1000',
            ...
            $template_array['stack_description'] = __('The "Give Online" stack template included in the Church Plant Theme Bundle', 'church_plant_theme_bundle' );
