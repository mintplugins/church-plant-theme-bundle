<?php
		/**
	   	 * Add Life Groups to the list of installed stack templates
	   	 *
	   	 * @since    1.0.0
	   	 * @link     http://mintplugins.com/doc/mp_stacks_templates_add_church_plant_theme_bundle_church_plant_life_groups
	   	 * @see      function_name()
	   	 * @param    array $installed_templates See link for description.
	   	 * @return   array $installed_templates See link for description.
	   	 */
	   	function mp_stacks_templates_add_church_plant_theme_bundle_church_plant_life_groups( $installed_templates ){

	   		$installed_templates['mp_stacks_church_plant_theme_bundle_church_plant_life_groups_array'] = array(
	   			'template_slug' => 'church_plant_theme_bundle_church_plant_life_groups',
	   			'template_title' => __( 'Life Groups', 'church_plant_theme_bundle' ),
	   			'template_description' => __('The "Life Groups" stack template included in the Church Plant Theme Bundle', 'church_plant_theme_bundle' ),
	   			'template_tags' => 'church',
	   			'template_preview_img' => '',
	   			'template_demo_url' => 'https://demo.mintplugins.com/church-plant/stack/church-plant-theme-bundle-church-plant-life-groups',
	   		);

	   		return $installed_templates;

	   	}
	   	add_filter( 'mp_stacks_installed_templates', 'mp_stacks_templates_add_church_plant_theme_bundle_church_plant_life_groups' );

		/**
		 * This function holds and returns the Life Groups Template Array
		 *
		 * @since    1.0.0
		 * @link     http://mintplugins.com/doc/mp-stacks-stack-template-function
		 * @return   array The Stack Template Aray
		 */
		function mp_stacks_church_plant_theme_bundle_church_plant_life_groups_array(){

			$template_array = array (
  'stack_title' => '',
  'stack_description' => 'Created using: Created using: Church Plant Theme Bundle\'s "Life Groups" Stack.',
  'stack_bricks' => 
  array (
    'brick_1' => 
    array (
    ...
    'brick_2' => 
    array (
      'brick_title' => 'Life Groups_brick 1',
      'mp_stack_order' => 1010,
      '_edit_lock' => 
      array (
        'value' => '1467476739:10',
...
',
      ...
      array (
        'value' => 'mp_stacks_parallax_on',
            ...
            $template_array['stack_description'] = __('The "Life Groups" stack template included in the Church Plant Theme Bundle', 'church_plant_theme_bundle' );
