<?php
		/**
	   	 ...
	   	 *
	   	 * @since    1.0.0
	   	 * @link     http://mintplugins.com/doc/mp_stacks_templates_add_church_plant_theme_bundle_church_plant_connect
	   	 * @see      function_name()
	   	 * @param    array $installed_templates See link for description.
	   	 * @return   array $installed_templates See link for description.
	   	 */
	   	function mp_stacks_templates_add_church_plant_theme_bundle_church_plant_connect( $installed_templates ){

	   		$installed_templates['mp_stacks_church_plant_theme_bundle_church_plant_connect_array'] = array(
	   			'template_slug' => 'church_plant_theme_bundle_church_plant_connect',
	   			'template_title' => __( 'Connect', 'church_plant_theme_bundle' ),
	   			'template_description' => __('The "Connect" stack template included in the Church Plant Theme Bundle', 'church_plant_theme_bundle' ),
	   			'template_tags' => 'church',
	   			'template_preview_img' => '',
	   			'template_demo_url' => 'https://demo.mintplugins.com/church-plant/stack/church-plant-theme-bundle-church-plant-connect',
	   		);

	   		return $installed_templates;

	   	}
	   	add_filter( 'mp_stacks_installed_templates', 'mp_stacks_templates_add_church_plant_theme_bundle_church_plant_connect' );
		 ...
		 */
		function mp_stacks_church_plant_theme_bundle_church_plant_connect_array(){
...
',
      ...
      array (
        'value' => '115',
            ...
            $template_array['stack_description'] = __('The "Connect" stack template included in the Church Plant Theme Bundle', 'church_plant_theme_bundle' );
