<?php 
/**
 * MP Stacks Template Resources
 *
 * @link http://mintplugins.com/doc/
 * @since 1.0.0
 *
 * @package     MP Stacks Template Resources
 ...
 */
	 ...
	 *
	 * @since    1.0.0
	 * @link     http://mintplugins.com/doc/mp_stacks_templates_add_church_plant_resources
	 * @see      function_name()
	 * @param    array $installed_templates See link for description.
	 * @return   array $installed_templates See link for description.
	 */
	function mp_stacks_templates_add_church_plant_resources( $installed_templates ){ 
		
		$installed_templates['mp_stacks_church_plant_resources_array'] = array(
			'template_slug' => 'church_plant_resources',
			'template_title' => __( 'Resources', 'church_plant_theme_bundle' ),
			'template_description' => __('Created using: Church Plant Theme Bundle\'s "Resources" Stack.', 'church_plant_theme_bundle' ),
			'template_tags' => 'church, resources',
			'template_preview_img' => plugins_url( '/images/preview_thumbnail.jpg', __FILE__ ),
			'template_demo_url' => 'https://demo.mintplugins.com/church-plant/resources/',
		);
		
		return $installed_templates;
	
	}
	add_filter( 'mp_stacks_installed_templates', 'mp_stacks_templates_add_church_plant_resources' );
	
	/**
	 * Add This Stack Template to the list of Default Stacks to create when the parent Theme Bundle is activated.
	 *
	 * @since    1.0.0
	 * @link     https://mintplugins.com/doc/mp_stacks_templates_church_plant_resources_to_default_stacks
	 * @see      function_name()
	 ...
	 */
	function mp_stacks_templates_church_plant_resources_to_default_stacks( $default_stacks_to_create ){ 
				
		$default_stacks_to_create['page']['church_plant_resources'] = array( 'title' => 'Resources','add_to_primary_menu' => 'true', );
		
		return $default_stacks_to_create;
	
	}
	add_filter( 'church_plant_theme_bundle_default_stacks', 'mp_stacks_templates_church_plant_resources_to_default_stacks' );
	 ...
	 */
	function mp_stacks_church_plant_resources_array(){ 
