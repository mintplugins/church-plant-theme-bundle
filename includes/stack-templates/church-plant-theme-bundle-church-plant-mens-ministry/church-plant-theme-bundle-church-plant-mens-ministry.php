<?php
		/**
	   	 * Add Men's Ministry to the list of installed stack templates
	   	 *
	   	 * @since    1.0.0
	   	 * @link     http://mintplugins.com/doc/mp_stacks_templates_add_church_plant_theme_bundle_church_plant_mens_ministry
	   	 * @see      function_name()
	   	 * @param    array $installed_templates See link for description.
	   	 * @return   array $installed_templates See link for description.
	   	 */
	   	function mp_stacks_templates_add_church_plant_theme_bundle_church_plant_mens_ministry( $installed_templates ){
	   	...
	   	add_filter( 'mp_stacks_installed_templates', 'mp_stacks_templates_add_church_plant_theme_bundle_church_plant_mens_ministry' );

		/**
		 * This function holds and returns the Men's Ministry Template Array
		 *
		 * @since    1.0.0
		 * @link     http://mintplugins.com/doc/mp-stacks-stack-template-function
		 * @return   array The Stack Template Aray
		 */
		function mp_stacks_church_plant_theme_bundle_church_plant_mens_ministry_array(){

			$template_array = array (
  'stack_title' => '',
  'stack_description' => 'Created using: Created using: Church Plant Theme Bundle\'s "Men\'s Ministry" Stack.',
  'stack_bricks' => 
  array (
    'brick_1' => 
    array (
    ...
    'brick_2' => 
    array (
      'brick_title' => 'Men&#8217;s Ministry_brick 1',
      'mp_stack_order' => 1010,
      '_edit_lock' => 
      array (
        'value' => '1467476972:10',
