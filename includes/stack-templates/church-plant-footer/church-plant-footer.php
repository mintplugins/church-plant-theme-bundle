 ...
 */
	 ...
	 *
	 * @since    1.0.0
	 * @link     http://mintplugins.com/doc/mp_stacks_templates_add_church_plant_footer
	 * @see      function_name()
	 * @param    array $installed_templates See link for description.
	 * @return   array $installed_templates See link for description.
	 */
	function mp_stacks_templates_add_church_plant_footer( $installed_templates ){ 
		
		$installed_templates['mp_stacks_church_plant_footer_array'] = array(
			'template_slug' => 'church_plant_footer',
			'template_title' => __( 'Footer', 'church_plant_theme_bundle' ),
			'template_description' => __('Created using: Church Plant Theme Bundle\'s "Footer" Stack.', 'church_plant_theme_bundle' ),
	...
	add_filter( 'mp_stacks_installed_templates', 'mp_stacks_templates_add_church_plant_footer' );
	
	/**
	 * Add This Stack Template to the list of Default Stacks to create when the parent Theme Bundle is activated.
	 *
	 * @since    1.0.0
	 * @link     https://mintplugins.com/doc/mp_stacks_templates_church_plant_footer_to_default_stacks
	 * @see      function_name()
	 ...
	 */
	function mp_stacks_templates_church_plant_footer_to_default_stacks( $default_stacks_to_create ){ 
				
		$default_stacks_to_create['none']['church_plant_footer'] = array( 'title' => 'Footer','is_footer' => true, );
		
		return $default_stacks_to_create;
	
	}
	add_filter( 'church_plant_theme_bundle_default_stacks', 'mp_stacks_templates_church_plant_footer_to_default_stacks' );
	 ...
	 */
	function mp_stacks_church_plant_footer_array(){ 
