<?php
		/**
	   	 * Add Youth Group to the list of installed stack templates
	   	 *
	   	 * @since    1.0.0
	   	 * @link     http://mintplugins.com/doc/mp_stacks_templates_add_church_plant_theme_bundle_church_plant_youth_group
	   	 * @see      function_name()
	   	 * @param    array $installed_templates See link for description.
	   	 * @return   array $installed_templates See link for description.
	   	 */
	   	function mp_stacks_templates_add_church_plant_theme_bundle_church_plant_youth_group( $installed_templates ){

	   		$installed_templates['mp_stacks_church_plant_theme_bundle_church_plant_youth_group_array'] = array(
	   			'template_slug' => 'church_plant_theme_bundle_church_plant_youth_group',
	   			'template_title' => __( 'Youth Group', 'church_plant_theme_bundle' ),
	   			'template_description' => __('The "Youth Group" stack template included in the Church Plant Theme Bundle', 'church_plant_theme_bundle' ),
	   			'template_tags' => 'church',
	   			'template_preview_img' => '',
	   			'template_demo_url' => 'https://demo.mintplugins.com/church-plant/stack/church-plant-theme-bundle-church-plant-youth-group',
	   		);

	   		return $installed_templates;

	   	}
	   	add_filter( 'mp_stacks_installed_templates', 'mp_stacks_templates_add_church_plant_theme_bundle_church_plant_youth_group' );

		/**
		 * This function holds and returns the Youth Group Template Array
		 *
		 * @since    1.0.0
		 * @link     http://mintplugins.com/doc/mp-stacks-stack-template-function
		 * @return   array The Stack Template Aray
		 */
		function mp_stacks_church_plant_theme_bundle_church_plant_youth_group_array(){

			$template_array = array (
  'stack_title' => '',
  'stack_description' => 'Created using: Created using: Church Plant Theme Bundle\'s "Youth Group" Stack.',
  'stack_bricks' => 
  array (
    'brick_1' => 
    array (
    ...
    'brick_2' => 
    array (
      'brick_title' => 'Youth Group_brick 1',
      'mp_stack_order' => 1010,
      '_edit_lock' => 
      array (
        'value' => '1467476900:10',
...
',
      ...
      array (
        'value' => 'mp_stacks_parallax_on',
            ...
            $template_array['stack_description'] = __('The "Youth Group" stack template included in the Church Plant Theme Bundle', 'church_plant_theme_bundle' );
