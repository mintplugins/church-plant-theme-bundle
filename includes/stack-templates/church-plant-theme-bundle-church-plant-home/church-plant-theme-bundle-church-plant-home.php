<?php
		/**
	   	 ...
	   	 *
	   	 * @since    1.0.0
	   	 * @link     http://mintplugins.com/doc/mp_stacks_templates_add_church_plant_theme_bundle_church_plant_home
	   	 * @see      function_name()
	   	 * @param    array $installed_templates See link for description.
	   	 * @return   array $installed_templates See link for description.
	   	 */
	   	function mp_stacks_templates_add_church_plant_theme_bundle_church_plant_home( $installed_templates ){

	   		$installed_templates['mp_stacks_church_plant_theme_bundle_church_plant_home_array'] = array(
	   			'template_slug' => 'church_plant_theme_bundle_church_plant_home',
	   			'template_title' => __( 'Home', 'church_plant_theme_bundle' ),
	   			'template_description' => __('The "Home" stack template included in the Church Plant Theme Bundle', 'church_plant_theme_bundle' ),
	   			'template_tags' => 'church',
	   			'template_preview_img' => '',
	   			'template_demo_url' => 'https://demo.mintplugins.com/church-plant/stack/church-plant-theme-bundle-church-plant-home',
	   		);

	   		return $installed_templates;

	   	}
	   	add_filter( 'mp_stacks_installed_templates', 'mp_stacks_templates_add_church_plant_theme_bundle_church_plant_home' );
		 ...
		 */
		function mp_stacks_church_plant_theme_bundle_church_plant_home_array(){
...
',
          ...
          array (
            ...
            'feature_text' => 
            array (
              'value' => '&lt;p&gt;Integer dictum sit suscipit wisi, nunc nulla tortor, per rhoncus nullam vel 123 Time Square, New York&lt;/p&gt;
',
              'attachment' => false,
            ),
          ),
...
',
      ...
      array (
        'value' => '35',
            ...
            $template_array['stack_description'] = __('The "Home" stack template included in the Church Plant Theme Bundle', 'church_plant_theme_bundle' );
