...
*/
if (!function_exists('mp_church_plant_theme_bundle_child_theme_plugin_check')){
	function mp_church_plant_theme_bundle_child_theme_plugin_check( $plugins ) {
		...
		if ( $current_theme->get( 'Name' ) != 'Church Plant Theme Bundle (Child Theme)' ){
			...
			$add_plugins = array(
				array(
					...
					'plugin_message' => __('You require the Church Plant Theme Bundle (Child Theme). Install it here.', 'mp_church_plant_theme_bundle_child_theme'),
					'plugin_filename' => '',
					'plugin_download_link' => 'http://mintplugins.com/theme-bundle-child-themes/church-plant-theme-bundle-child-theme.zip',
...
add_filter( 'mp_core_check_plugins', 'mp_church_plant_theme_bundle_child_theme_plugin_check' );